...
//        NSString *aStrURl=[NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/queryautocomplete/json?&key=%@&sensor=false&input=%@",_strApiKey,aQuery];
        ...
        [self returnDictionaryDataWithURL:[NSURL URLWithString:aStrURl] withResponseCallback:^(NSDictionary * dictionaryData) {
            NSMutableDictionary *aResultDict = dictionaryData.mutableCopy;
